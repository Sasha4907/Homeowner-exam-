       ...
       <div class="information">
          ...
          <div class="rightText">
            <form action="add_new.php" method="post" name="rent">
                ...
                <input type="text" name="login" placeholder="Введіть прізвище" required >
                <label>Пароль</label><br>
                <input type="text" name="password" placeholder="Введіть пароль" minlength="5" maxlength="20" required >
